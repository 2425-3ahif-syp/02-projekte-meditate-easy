...
image::wireframe_exercise_select.png[wf1, 1000, 562]

=== Instruktion (mit Timer)
image::wireframe_exercise_timer.png[wf2, 1000, 562]

=== Instruktion (mit Stoppuhr)
image::wireframe_exercise_stopwatch.png[wf3, 1000, 562]

=== Auswahl Videos
image::wireframe_video_select.png[wf4, 1000, 562]

=== Anleitungsvideo
image::wireframe_video_view.png[wf5, 1000, 562]
