...
image::wireframe_exercise_select.png[background, size="contain"]

=== Instruktion (mit Timer)
image::wireframe_exercise_timer.png[background, size="contain"]

=== Instruktion (mit Stoppuhr)
image::wireframe_exercise_stopwatch.png[background, size="contain"]

=== Auswahl Videos
image::wireframe_video_select.png[background, size="contain"]

=== Anleitungsvideo
image::wireframe_video_view.png[background, size="contain"]
